                        ...
                        <form id="orderForm" name="orderForm" @submit.prevent="submit">
                            <div class="form-box address-info">
                                <dl class="form-group">
                                    ...
                                    <dd>
                                        ...
                                        <input name="accept_name" v-model="form.accept_name" id="accept_name" type="text" class="input" datatype="s2-20" sucmsg=" ">
                                ...
                                <dl class="form-group">
                                    <dt>详细地址：</dt>
                                    <dd>
                                        <input name="address" v-model="form.address" id="address" type="text" class="input" datatype="*2-100" sucmsg=" ">
                                ...
                                <dl class="form-group">
                                    <dt>手机号码：</dt>
                                    <dd>
                                        <input name="mobile" v-model="form.mobile" id="mobile" type="text" class="input" datatype="m" sucmsg=" ">
                                ...
                                <dl class="form-group">
                                    <dt>电子邮箱：</dt>
                                    <dd>
                                        <input name="email" v-model="form.email" id="email" type="text" class="input" value="">
                                ...
                                <dl class="form-group">
                                    <dt>邮政编码：</dt>
                                    <dd>
                                        <input name="post_code" v-model="form.post_code" id="post_code" type="txt" class="input code">
                            ...
                            <div class="buy-foot clearfix">
                                ...
                                <div class="right-box">
                                    <p>
                                        商品
                                        <label class="price">{{$store.getters.total}}</label> 件&nbsp;&nbsp;&nbsp;&nbsp; 商品金额：￥
                                        <label id="goodsAmount" class="price">10000</label> 元&nbsp;&nbsp;&nbsp;&nbsp;
                                    </p>
                                    <p>
                                        运费：￥
...
<script>
    ...
    submit(){
        this.$http.post(this.$api.orderSubmit,this.form).then(res => {
            if(res.data.status == 0){
                this.$route.push({ name: 'pay', params: { id:1} })
            }
        })
    }
    },
